...
if (!class_exists('TMC_v1_0_6_AdminPageFramework_Registry', false)):
    abstract class TMC_v1_0_6_AdminPageFramework_Registry_Base {
    ...
    final class TMC_v1_0_6_AdminPageFramework_Registry extends TMC_v1_0_6_AdminPageFramework_Registry_Base {
        ...
        static public function setUp($sFilePath = __FILE__) {
            ...
            self::$sAutoLoaderPath = isset(self::$aClassFiles['TMC_v1_0_6_AdminPageFramework_RegisterClasses']) ? self::$aClassFiles['TMC_v1_0_6_AdminPageFramework_RegisterClasses'] : '';
            self::$bIsMinifiedVersion = class_exists('TMC_v1_0_6_AdminPageFramework_MinifiedVersionHeader', false);
            self::$bIsDevelopmentVersion = isset(self::$aClassFiles['TMC_v1_0_6_AdminPageFramework_InclusionClassFilesHeader']);
        }
    ...
    if (!class_exists('TMC_v1_0_6_AdminPageFramework_Bootstrap', false)):
        final class TMC_v1_0_6_AdminPageFramework_Bootstrap {
            static private $_bLoaded = false;
            public function __construct($sLibraryPath) {
                if (!$this->_isLoadable()) {
                    return;
                }
                TMC_v1_0_6_AdminPageFramework_Registry::setUp($sLibraryPath);
                if (TMC_v1_0_6_AdminPageFramework_Registry::$bIsMinifiedVersion) {
                    return;
                }
                $this->_include();
            }
            ...
            private function _include() {
                include (TMC_v1_0_6_AdminPageFramework_Registry::$sAutoLoaderPath);
                new TMC_v1_0_6_AdminPageFramework_RegisterClasses('', array('exclude_class_names' => array('TMC_v1_0_6_AdminPageFramework_MinifiedVersionHeader', 'TMC_v1_0_6_AdminPageFramework_BeautifiedVersionHeader',),), TMC_v1_0_6_AdminPageFramework_Registry::$aClassFiles);
                self::$_bXDebug = isset(self::$_bXDebug) ? self::$_bXDebug : extension_loaded('xdebug');
                if (self::$_bXDebug) {
                    new TMC_v1_0_6_AdminPageFramework_Utility;
                    new TMC_v1_0_6_AdminPageFramework_WPUtility;
                }
            }
            static private $_bXDebug;
        }
        new TMC_v1_0_6_AdminPageFramework_Bootstrap(__FILE__);
    endif;
