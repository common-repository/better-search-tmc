...
abstract class TMC_v1_0_6_AdminPageFramework_TermMeta_Router extends TMC_v1_0_6_AdminPageFramework_TaxonomyField_Controller {
    }
    abstract class TMC_v1_0_6_AdminPageFramework_TermMeta_Model extends TMC_v1_0_6_AdminPageFramework_TermMeta_Router {
        ...
        private function _getSavedTermMetas($iTermID, array $aFieldsets) {
            $_oMetaData = new TMC_v1_0_6_AdminPageFramework_TermMeta_Model___TermMeta($iTermID, $this->oForm->aFieldsets);
    ...
    abstract class TMC_v1_0_6_AdminPageFramework_TermMeta_View extends TMC_v1_0_6_AdminPageFramework_TermMeta_Model {
    ...
    abstract class TMC_v1_0_6_AdminPageFramework_TermMeta_Controller extends TMC_v1_0_6_AdminPageFramework_TermMeta_View {
    }
    abstract class TMC_v1_0_6_AdminPageFramework_TermMeta extends TMC_v1_0_6_AdminPageFramework_TermMeta_Controller {
        protected $_sStructureType = 'term_meta';
        public function __construct($asTaxonomySlug, $sCapability = 'manage_options', $sTextDomain = 'tmcapf') {
