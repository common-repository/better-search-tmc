...
abstract class TMC_v1_0_6_AdminPageFramework_PostType_Router extends TMC_v1_0_6_AdminPageFramework_Factory {
    ...
    abstract class TMC_v1_0_6_AdminPageFramework_PostType_Model extends TMC_v1_0_6_AdminPageFramework_PostType_Router {
        public function __construct($oProp) {
            parent::__construct($oProp);
            ...
            if ($this->oProp->bIsAdmin) {
                ...
                if ($this->oProp->sCallerPath) {
                    new TMC_v1_0_6_AdminPageFramework_PostType_Model__FlushRewriteRules($this);
                }
            }
        }
        ...
        public function _replyToRegisterPostType() {
            ...
            new TMC_v1_0_6_AdminPageFramework_PostType_Model__SubMenuOrder($this);
        }
    ...
    abstract class TMC_v1_0_6_AdminPageFramework_PostType_View extends TMC_v1_0_6_AdminPageFramework_PostType_Model {
        public function __construct($oProp) {
            parent::__construct($oProp);
            if ($this->oProp->bIsAdmin) {
        ...
        public function _replyToPrintStyle() {
            ...
            if (!empty($this->oProp->sStyle)) {
                echo "<style type='text/css' id='tmcapf-style-post-type'>" . $this->oProp->sStyle . "</style>";
            }
        }
    ...
    abstract class TMC_v1_0_6_AdminPageFramework_PostType_Controller extends TMC_v1_0_6_AdminPageFramework_PostType_View {
    ...
    abstract class TMC_v1_0_6_AdminPageFramework_PostType extends TMC_v1_0_6_AdminPageFramework_PostType_Controller {
        protected $_sStructureType = 'post_type';
        public function __construct($sPostType, $aArguments = array(), $sCallerPath = null, $sTextDomain = 'tmcapf') {
            if (empty($sPostType)) {
                return;
            }
            $_sProprtyClassName = isset($this->aSubClassNames['oProp']) ? $this->aSubClassNames['oProp'] : 'TMC_v1_0_6_AdminPageFramework_Property_' . $this->_sStructureType;
            ...
            $this->oProp->sPostType = TMC_v1_0_6_AdminPageFramework_WPUtility::sanitizeSlug($sPostType);
            $this->oProp->aPostTypeArgs = $aArguments;
        ...
        private function _getCallerScriptPath($sCallerPath) {
            ...
            $_sPageNow = TMC_v1_0_6_AdminPageFramework_Utility::getElement($GLOBALS, 'pagenow');
            if (in_array($_sPageNow, array('edit.php', 'post.php', 'post-new.php', 'plugins.php', 'tags.php', 'edit-tags.php', 'term.php'))) {
                return TMC_v1_0_6_AdminPageFramework_Utility::getCallerScriptPath(__FILE__);
            }
            return null;
        }
    }
