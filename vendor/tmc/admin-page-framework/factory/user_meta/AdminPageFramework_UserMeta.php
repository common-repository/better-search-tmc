...
abstract class TMC_v1_0_6_AdminPageFramework_UserMeta_Router extends TMC_v1_0_6_AdminPageFramework_Factory {
    ...
    abstract class TMC_v1_0_6_AdminPageFramework_UserMeta_Model extends TMC_v1_0_6_AdminPageFramework_UserMeta_Router {
        public function _replyToGetSavedFormData() {
            $_iUserID = isset($GLOBALS['profileuser']->ID) ? $GLOBALS['profileuser']->ID : 0;
            $_oMetaData = new TMC_v1_0_6_AdminPageFramework_UserMeta_Model___UserMeta($_iUserID, $this->oForm->aFieldsets);
    ...
    abstract class TMC_v1_0_6_AdminPageFramework_UserMeta_View extends TMC_v1_0_6_AdminPageFramework_UserMeta_Model {
    ...
    abstract class TMC_v1_0_6_AdminPageFramework_UserMeta_Controller extends TMC_v1_0_6_AdminPageFramework_UserMeta_View {
    ...
    abstract class TMC_v1_0_6_AdminPageFramework_UserMeta extends TMC_v1_0_6_AdminPageFramework_UserMeta_Controller {
        protected $_sStructureType = 'user_meta';
        public function __construct($sCapability = 'read', $sTextDomain = 'tmcapf') {
