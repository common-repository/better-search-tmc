...
abstract class TMC_v1_0_6_AdminPageFramework_PageMetaBox_Router extends TMC_v1_0_6_AdminPageFramework_MetaBox_View {
    ...
    abstract class TMC_v1_0_6_AdminPageFramework_PageMetaBox_Model extends TMC_v1_0_6_AdminPageFramework_PageMetaBox_Router {
    ...
    abstract class TMC_v1_0_6_AdminPageFramework_PageMetaBox_View extends TMC_v1_0_6_AdminPageFramework_PageMetaBox_Model {
    }
    abstract class TMC_v1_0_6_AdminPageFramework_PageMetaBox_Controller extends TMC_v1_0_6_AdminPageFramework_PageMetaBox_View {
    ...
    abstract class TMC_v1_0_6_AdminPageFramework_PageMetaBox extends TMC_v1_0_6_AdminPageFramework_PageMetaBox_Controller {
        protected $_sStructureType = 'page_meta_box';
        public function __construct($sMetaBoxID, $sTitle, $asPageSlugs = array(), $sContext = 'normal', $sPriority = 'default', $sCapability = 'manage_options', $sTextDomain = 'tmcapf') {
