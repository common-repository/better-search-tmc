...
class TMC_v1_0_6_AdminPageFramework_Form_post_meta_box extends TMC_v1_0_6_AdminPageFramework_Form_Meta {
    public $sStructureType = 'post_meta_box';
    public function construct() {
        $this->_addDefaultResources();
    }
    private function _addDefaultResources() {
        $_oCSS = new TMC_v1_0_6_AdminPageFramework_Form_View___CSS_meta_box;
