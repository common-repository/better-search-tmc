...
abstract class TMC_v1_0_6_AdminPageFramework_MetaBox_Router extends TMC_v1_0_6_AdminPageFramework_Factory {
    public function __construct($sMetaBoxID, $sTitle, $asPostTypeOrScreenID = array('post'), $sContext = 'normal', $sPriority = 'default', $sCapability = 'edit_posts', $sTextDomain = 'tmcapf') {
    ...
    abstract class TMC_v1_0_6_AdminPageFramework_MetaBox_Model extends TMC_v1_0_6_AdminPageFramework_MetaBox_Router {
        public function __construct($sMetaBoxID, $sTitle, $asPostTypeOrScreenID = array('post'), $sContext = 'normal', $sPriority = 'default', $sCapability = 'edit_posts', $sTextDomain = 'tmcapf') {
        ...
        public function _replyToGetSavedFormData() {
            $_oMetaData = new TMC_v1_0_6_AdminPageFramework_MetaBox_Model___PostMeta($this->_getPostID(), $this->oForm->aFieldsets);
    ...
    abstract class TMC_v1_0_6_AdminPageFramework_MetaBox_View extends TMC_v1_0_6_AdminPageFramework_MetaBox_Model {
    ...
    abstract class TMC_v1_0_6_AdminPageFramework_MetaBox_Controller extends TMC_v1_0_6_AdminPageFramework_MetaBox_View {
    ...
    abstract class TMC_v1_0_6_AdminPageFramework_MetaBox extends TMC_v1_0_6_AdminPageFramework_MetaBox_Controller {
