...
abstract class TMC_v1_0_6_AdminPageFramework_Property_Base extends TMC_v1_0_6_AdminPageFramework_FrameworkUtility {
    ...
    private function ___setProperties($oCaller, $sCallerPath, $sClassName, $sCapability, $sTextDomain, $sStructureType) {
        ...
        $this->sTextDomain = empty($sTextDomain) ? 'tmcapf' : $sTextDomain;
    ...
    private function ___setGlobals() {
        if (!isset($GLOBALS['aTMC_v1_0_6_AdminPageFramework'])) {
            $GLOBALS['aTMC_v1_0_6_AdminPageFramework'] = array('aFieldFlags' => array());
        }
    }
    ...
    static public function _setLibraryData() {
        self::$_aLibraryData = array('sName' => TMC_v1_0_6_AdminPageFramework_Registry::NAME, 'sURI' => TMC_v1_0_6_AdminPageFramework_Registry::URI, 'sScriptName' => TMC_v1_0_6_AdminPageFramework_Registry::NAME, 'sLibraryName' => TMC_v1_0_6_AdminPageFramework_Registry::NAME, 'sLibraryURI' => TMC_v1_0_6_AdminPageFramework_Registry::URI, 'sPluginName' => '', 'sPluginURI' => '', 'sThemeName' => '', 'sThemeURI' => '', 'sVersion' => TMC_v1_0_6_AdminPageFramework_Registry::getVersion(), 'sDescription' => TMC_v1_0_6_AdminPageFramework_Registry::DESCRIPTION, 'sAuthor' => TMC_v1_0_6_AdminPageFramework_Registry::AUTHOR, 'sAuthorURI' => TMC_v1_0_6_AdminPageFramework_Registry::AUTHOR_URI, 'sTextDomain' => TMC_v1_0_6_AdminPageFramework_Registry::TEXT_DOMAIN, 'sDomainPath' => TMC_v1_0_6_AdminPageFramework_Registry::TEXT_DOMAIN_PATH, 'sNetwork' => '', '_sitewide' => '',);
    ...
    public function __get($sName) {
        ...
        if ('oUtil' === $sName) {
            $this->oUtil = new TMC_v1_0_6_AdminPageFramework_WPUtility;
            return $this->oUtil;
        }
    }
    }
