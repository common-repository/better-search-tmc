...
class TMC_v1_0_6_AdminPageFramework_Message {
    ...
    protected $_sTextDomain = 'tmcapf';
    static private $_aInstancesByTextDomain = array();
    public static function getInstance($sTextDomain = 'tmcapf') {
        $_oInstance = isset(self::$_aInstancesByTextDomain[$sTextDomain]) && (self::$_aInstancesByTextDomain[$sTextDomain] instanceof TMC_v1_0_6_AdminPageFramework_Message) ? self::$_aInstancesByTextDomain[$sTextDomain] : new TMC_v1_0_6_AdminPageFramework_Message($sTextDomain);
        self::$_aInstancesByTextDomain[$sTextDomain] = $_oInstance;
        return self::$_aInstancesByTextDomain[$sTextDomain];
    }
    public static function instantiate($sTextDomain = 'tmcapf') {
        return self::getInstance($sTextDomain);
    }
    public function __construct($sTextDomain = 'tmcapf') {
    ...
    private function ___doDummy() {
        __('The options have been updated.', 'tmcapf');
        __('The options have been cleared.', 'tmcapf');
        __('Export', 'tmcapf');
        __('Export Options', 'tmcapf');
        __('Import', 'tmcapf');
        __('Import Options', 'tmcapf');
        __('Submit', 'tmcapf');
        __('An error occurred while uploading the import file.', 'tmcapf');
        __('The uploaded file type is not supported: %1$s', 'tmcapf');
        __('Could not load the importing data.', 'tmcapf');
        __('The uploaded file has been imported.', 'tmcapf');
        __('No data could be imported.', 'tmcapf');
        __('Upload Image', 'tmcapf');
        __('Use This Image', 'tmcapf');
        __('Insert from URL', 'tmcapf');
        __('Are you sure you want to reset the options?', 'tmcapf');
        __('Please confirm your action.', 'tmcapf');
        __('The specified options have been deleted.', 'tmcapf');
        __('A problem occurred while processing the form data. Please try again.', 'tmcapf');
        __('Not all form fields could not be sent. Please check your server settings of PHP <code>max_input_vars</code> and consult the server administrator to increase the value. <code>max input vars</code>: %1$s. <code>$_POST</code> count: %2$s', 'tmcapf');
        __('Is it okay to send the email?', 'tmcapf');
        __('The email has been sent.', 'tmcapf');
        __('The email has been scheduled.', 'tmcapf');
        __('There was a problem sending the email', 'tmcapf');
        __('Title', 'tmcapf');
        __('Author', 'tmcapf');
        __('Categories', 'tmcapf');
        __('Tags', 'tmcapf');
        __('Comments', 'tmcapf');
        __('Date', 'tmcapf');
        __('Show All', 'tmcapf');
        __('Show All Authors', 'tmcapf');
        __('Thank you for creating with', 'tmcapf');
        __('and', 'tmcapf');
        __('Settings', 'tmcapf');
        __('Manage', 'tmcapf');
        __('Select Image', 'tmcapf');
        __('Upload File', 'tmcapf');
        __('Use This File', 'tmcapf');
        __('Select File', 'tmcapf');
        __('Remove Value', 'tmcapf');
        __('Select All', 'tmcapf');
        __('Select None', 'tmcapf');
        __('No term found.', 'tmcapf');
        __('Select', 'tmcapf');
        __('Insert', 'tmcapf');
        __('Use This', 'tmcapf');
        __('Return to Library', 'tmcapf');
        __('%1$s queries in %2$s seconds.', 'tmcapf');
        __('%1$s out of %2$s MB (%3$s) memory used.', 'tmcapf');
        __('Peak memory usage %1$s MB.', 'tmcapf');
        __('Initial memory usage  %1$s MB.', 'tmcapf');
        __('The allowed maximum number of fields is {0}.', 'tmcapf');
        __('The allowed minimum number of fields is {0}.', 'tmcapf');
        __('Add', 'tmcapf');
        __('Remove', 'tmcapf');
        __('The allowed maximum number of sections is {0}', 'tmcapf');
        __('The allowed minimum number of sections is {0}', 'tmcapf');
        __('Add Section', 'tmcapf');
        __('Remove Section', 'tmcapf');
        __('Toggle All', 'tmcapf');
        __('Toggle all collapsible sections', 'tmcapf');
        __('Reset', 'tmcapf');
        __('Yes', 'tmcapf');
        __('No', 'tmcapf');
        __('On', 'tmcapf');
        ...
        __('Disabled', 'tmcapf');
        __('Supported', 'tmcapf');
        __('Not Supported', 'tmcapf');
        __('Functional', 'tmcapf');
        __('Not Functional', 'tmcapf');
        __('Too Long', 'tmcapf');
        __('Acceptable', 'tmcapf');
        __('No log found.', 'tmcapf');
        __('The method is called too early: %1$s', 'tmcapf');
        __('Debug Info', 'tmcapf');
        __('Click here to expand to view the contents.', 'tmcapf');
        __('Click here to collapse the contents.', 'tmcapf');
        __('Loading...', 'tmcapf');
        __('Please enable JavaScript for better user experience.', 'tmcapf');
        __('Debug', 'tmcapf');
        __('Field Arguments', 'tmcapf');
        __('This information will be disabled when <code>WP_DEBUG</code> is set to <code>false</code> in <code>wp-config.php</code>.', 'tmcapf');
        __('Section Arguments', 'tmcapf');
        __('The ability to repeat sections is disabled.', 'tmcapf');
        __('The ability to repeat fields is disabled.', 'tmcapf');
        __('Warning.', 'tmcapf');
    }
    }
