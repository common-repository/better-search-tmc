...
abstract class TMC_v1_0_6_AdminPageFramework_Factory_Router {
    public $oProp;
    public $oDebug;
    public $oUtil;
    public $oMsg;
    ...
    protected $oHelpPane;
    protected $oLink;
    protected $_aSubClassPrefixes = array('oForm' => 'TMC_v1_0_6_AdminPageFramework_Form_', 'oPageLoadInfo' => 'TMC_v1_0_6_AdminPageFramework_PageLoadInfo_', 'oResource' => 'TMC_v1_0_6_AdminPageFramework_Resource_', 'oHelpPane' => 'TMC_v1_0_6_AdminPageFramework_HelpPane_', 'oLink' => 'TMC_v1_0_6_AdminPageFramework_Link_',);
    private $_aSubClassNames = array('oProp' => null, 'oDebug' => 'TMC_v1_0_6_AdminPageFramework_Debug', 'oUtil' => 'TMC_v1_0_6_AdminPageFramework_FrameworkUtility', 'oMsg' => 'TMC_v1_0_6_AdminPageFramework_Message', 'oForm' => null, 'oPageLoadInfo' => null, 'oResource' => null, 'oHelpPane' => null, 'oLink' => null,);
    ...
    private function _triggerUndefinedMethodWarning($sMethodName) {
        trigger_error(TMC_v1_0_6_AdminPageFramework_Registry::NAME . ': ' . sprintf(__('The method is not defined: %1$s', $this->oProp->sTextDomain), $sMethodName), E_USER_WARNING);
    }
    public function __toString() {
        return TMC_v1_0_6_AdminPageFramework_FrameworkUtility::getObjectInfo($this);
    }
    ...
    abstract class TMC_v1_0_6_AdminPageFramework_Factory_Model extends TMC_v1_0_6_AdminPageFramework_Factory_Router {
        public function __construct($oProp) {
    ...
    abstract class TMC_v1_0_6_AdminPageFramework_Factory_View extends TMC_v1_0_6_AdminPageFramework_Factory_Model {
        public function __construct($oProp) {
            parent::__construct($oProp);
            new TMC_v1_0_6_AdminPageFramework_Factory_View__SettingNotice($this, $this->oProp->sSettingNoticeActionHook);
        }
    ...
    abstract class TMC_v1_0_6_AdminPageFramework_Factory_Controller extends TMC_v1_0_6_AdminPageFramework_Factory_View {
    ...
    abstract class TMC_v1_0_6_AdminPageFramework_Factory extends TMC_v1_0_6_AdminPageFramework_Factory_Controller {
    }
