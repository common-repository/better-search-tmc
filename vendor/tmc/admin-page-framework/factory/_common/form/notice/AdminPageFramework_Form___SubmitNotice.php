...
class TMC_v1_0_6_AdminPageFramework_Form___SubmitNotice extends TMC_v1_0_6_AdminPageFramework_FrameworkUtility {
    ...
    public function render() {
        new TMC_v1_0_6_AdminPageFramework_AdminNotice('');
    ...
    private function _printNotices($aNotices) {
        ...
        foreach (array_filter(( array )$aNotices, 'is_array') as $_aNotice) {
            ...
            new TMC_v1_0_6_AdminPageFramework_AdminNotice($this->getElement($_aNotice, 'sMessage'), $this->getElement($_aNotice, 'aAttributes'));
        }
    }
    }
