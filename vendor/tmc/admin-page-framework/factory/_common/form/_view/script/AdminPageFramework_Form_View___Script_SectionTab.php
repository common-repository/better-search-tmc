...
class TMC_v1_0_6_AdminPageFramework_Form_View___Script_SectionTab extends TMC_v1_0_6_AdminPageFramework_Form_View___Script_Base {
...
jQuery( '.tmcapf-section-tabs-contents' ).createTabs(); 
});            
JAVASCRIPTS;
        return "<script type='text/javascript' class='tmcapf-section-tabs-script'>" . '/* <![CDATA[ */' . $_sScript . '/* ]]> */' . "</script>";
    }
    }
