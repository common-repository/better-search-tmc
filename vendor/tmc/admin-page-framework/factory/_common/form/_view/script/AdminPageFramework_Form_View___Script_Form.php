...
class TMC_v1_0_6_AdminPageFramework_Form_View___Script_Form extends TMC_v1_0_6_AdminPageFramework_Form_View___Script_Base {
    static public function getScript() {
        return <<<JAVASCRIPTS
( function( $ ) {

    var _removeTMC_v1_0_6_AdminPageFrameworkLoadingOutputs = function() {

        jQuery( '.tmcapf-form-loading' ).remove();
        jQuery( '.tmcapf-form-js-on' )
            .hide()
            .css( 'visibility', 'visible' )
            .fadeIn( 200 )
            .removeClass( '.tmcapf-form-js-on' );
    ...
    window.onerror = function(){
        ...
        _removeTMC_v1_0_6_AdminPageFrameworkLoadingOutputs();
