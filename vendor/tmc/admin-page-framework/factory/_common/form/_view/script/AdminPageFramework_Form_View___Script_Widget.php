...
class TMC_v1_0_6_AdminPageFramework_Form_View___Script_Widget extends TMC_v1_0_6_AdminPageFramework_Form_View___Script_Base {
    ...
    $( document ).ready( function() {
        ...
        $( document ).ajaxComplete( function( event, XMLHttpRequest, ajaxOptions ) {
            ...
            if( _aRequest.action && ( 'save-widget' === _aRequest.action ) ) {
                ...
                if ( $( _oWidget ).find( '.tmcapf-sectionset' ).length <= 0 ) { 
                    return; 
                }   
