...
class TMC_v1_0_6_AdminPageFramework_Form_View___Generate_FieldInputName extends TMC_v1_0_6_AdminPageFramework_Form_View___Generate_FlatFieldName {
    public $sIndex = '';
    ...
    class TMC_v1_0_6_AdminPageFramework_Form_View___Generate_FlatFieldInputName extends TMC_v1_0_6_AdminPageFramework_Form_View___Generate_FieldInputName {
        public function get() {
            $_sIndex = $this->getAOrB('0' !== $this->sIndex && empty($this->sIndex), '', "|{$this->sIndex}");
