...
class TMC_v1_0_6_AdminPageFramework_Form_View___DebugInfo extends TMC_v1_0_6_AdminPageFramework_FrameworkUtility {
    ...
    public function get() {
        ...
        return "<div class='tmcapf-info'>" . $this->oMsg->get('debug_info') . ': ' . $this->getFrameworkNameVersion() . "</div>";
    }
