...
abstract class TMC_v1_0_6_AdminPageFramework_FieldType_Base extends TMC_v1_0_6_AdminPageFramework_Form_Utility {
    ...
    public function __construct($asClassName = 'admin_page_framework', $asFieldTypeSlug = null, $oMsg = null, $bAutoRegister = true) {
        ...
        $this->oMsg = $oMsg ? $oMsg : TMC_v1_0_6_AdminPageFramework_Message::getInstance();
        if ($bAutoRegister) {
    ...
    protected function getFieldOutput(array $aFieldset) {
        ...
        $_oFieldset = new TMC_v1_0_6_AdminPageFramework_Form_View___Fieldset($aFieldset, $_oCallerForm->aSavedData, $_oCallerForm->getFieldErrors(), $_oCallerForm->aFieldTypeDefinitions, $_oCallerForm->oMsg, $_oCallerForm->aCallbacks);
    ...
    protected function enqueueMediaUploader() {
        ...
        if (function_exists('wp_enqueue_media')) {
            new TMC_v1_0_6_AdminPageFramework_Form_View___Script_MediaUploader($this->oMsg);
        } else {
    ...
    abstract class TMC_v1_0_6_AdminPageFramework_FieldType extends TMC_v1_0_6_AdminPageFramework_FieldType_Base {
        public function _replyToFieldLoader() {
            $this->setUp();
        }
        public function _replyToGetScripts() {
    ...
    class TMC_v1_0_6_AdminPageFramework_FieldType_color extends TMC_v1_0_6_AdminPageFramework_FieldType {
        ...
        protected function getStyles() {
            return ".repeatable .colorpicker {display: inline;}.tmcapf-field-color .wp-picker-container {vertical-align: middle;}.tmcapf-field-color .ui-widget-content {border: none;background: none;color: transparent;}.tmcapf-field-color .ui-slider-vertical {width: inherit;height: auto;margin-top: -11px;}.tmcapf-field-color .tmcapf-repeatable-field-buttons {margin-top: 0;}.tmcapf-field-color .wp-color-result {margin: 3px;}";
        }
        protected function getScripts() {
            $_aJSArray = json_encode($this->aFieldTypeSlugs);
            $_sDoubleQuote = '\"';
            return <<<JAVASCRIPTS
registerTMC_v1_0_6_AdminPageFrameworkColorPickerField = function( osTragetInput, aOptions ) {
    ...
    var _aDefaults = {
        ...
        change: function( event, ui ){
            jQuery( this ).trigger( 
                'tmcapf_field_type_color_changed',
        ...
        clear: function( event, ui ) {
            jQuery( this ).trigger(
                'tmcapf_field_type_color_cleared',
    ...
    jQuery().registerTMC_v1_0_6_AdminPageFrameworkCallbacks( {     
        ...
        repeated_field: function( oCloned, aModel ) {
            ...
            oCloned.find( 'input.input_color' ).each( function( iIterationIndex ) {
                ...
                registerTMC_v1_0_6_AdminPageFrameworkColorPickerField( _oNewColorInput );                
...
jQuery( document ).ready( function(){
    registerTMC_v1_0_6_AdminPageFrameworkColorPickerField( '{$sInputID}' );
});            
JAVASCRIPTS;
