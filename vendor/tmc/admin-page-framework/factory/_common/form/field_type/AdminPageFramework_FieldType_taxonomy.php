...
class TMC_v1_0_6_AdminPageFramework_FieldType_taxonomy extends TMC_v1_0_6_AdminPageFramework_FieldType_checkbox {
    ...
    protected function setUp() {
        new TMC_v1_0_6_AdminPageFramework_Form_View___Script_CheckboxSelector;
    }
    protected function getScripts() {
        $_aJSArray = json_encode($this->aFieldTypeSlugs);
        return parent::getScripts() . <<<JAVASCRIPTS
/* For tabs */
var enableTMC_v1_0_6_AdminPageFrameworkTabbedBox = function( nodeTabBoxContainer ) {
...
jQuery( document ).ready( function() {
    ...
    enableTMC_v1_0_6_AdminPageFrameworkTabbedBox( jQuery( '.tab-box-container' ) );
    ...
    jQuery().registerTMC_v1_0_6_AdminPageFrameworkCallbacks( {
        ...
        repeated_field: function( oCloned, aModel ) {
            ...
            // Initialize
            enableTMC_v1_0_6_AdminPageFrameworkTabbedBox( oCloned.find( '.tab-box-container' ) );
...
JAVASCRIPTS;
    ...
    protected function getStyles() {
        return ".tmcapf-field .taxonomy-checklist li { margin: 8px 0 8px 20px; }.tmcapf-field div.taxonomy-checklist {padding: 8px 0 8px 10px;margin-bottom: 20px;}.tmcapf-field .taxonomy-checklist ul {list-style-type: none;margin: 0;}.tmcapf-field .taxonomy-checklist ul ul {margin-left: 1em;}.tmcapf-field .taxonomy-checklist-label {white-space: nowrap; }.tmcapf-field .tab-box-container.categorydiv {max-height: none;}.tmcapf-field .tab-box-tab-text {display: inline-block;font-size: 13px;font-size: smaller;padding: 2px;}.tmcapf-field .tab-box-tabs {line-height: 12px;margin-bottom: 0;}.tmcapf-field .tab-box-tabs .tab-box-tab.active {display: inline;border-color: #dfdfdf #dfdfdf #fff;margin-bottom: 0px;padding-bottom: 4px;background-color: #fff;}.tmcapf-field .tab-box-container { position: relative; width: 100%; clear: both;margin-bottom: 1em;}.tmcapf-field .tab-box-tabs li a { color: #333; text-decoration: none; }.tmcapf-field .tab-box-contents-container {padding: 0 0 0 1.8em;padding: 0.55em 0.5em 0.55em 1.8em;border: 1px solid #dfdfdf; background-color: #fff;}.tmcapf-field .tab-box-contents { overflow: hidden; overflow-x: hidden; position: relative; top: -1px; height: 300px;}.tmcapf-field .tab-box-content { display: none; overflow: auto; display: block; position: relative; overflow-x: hidden;}.tmcapf-field .tab-box-content .taxonomychecklist {margin-right: 3.2em;}.tmcapf-field .tab-box-content:target, .tmcapf-field .tab-box-content:target, .tmcapf-field .tab-box-content:target { display: block; }.tmcapf-field .tab-box-content .select_all_button_container, .tmcapf-field .tab-box-content .select_none_button_container{display: inline-block;margin-top: 0.8em;}.tmcapf-field .taxonomychecklist .children {margin-top: 6px;margin-left: 1em;}";
    }
