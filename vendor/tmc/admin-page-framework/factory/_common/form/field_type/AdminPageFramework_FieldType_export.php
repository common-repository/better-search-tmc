...
class TMC_v1_0_6_AdminPageFramework_FieldType_submit extends TMC_v1_0_6_AdminPageFramework_FieldType {
    ...
    protected function getStyles() {
        return ".tmcapf-field input[type='submit'] {margin-bottom: 0.5em;}";
    }
    ...
    private function _getLabelContainerAttributes(array $aField) {
        return array('style' => $aField['label_min_width'] || '0' === ( string )$aField['label_min_width'] ? "min-width:" . $this->getLengthSanitized($aField['label_min_width']) . ";" : null, 'class' => 'tmcapf-input-label-container' . ' tmcapf-input-button-container' . ' tmcapf-input-container',);
    }
    ...
    class TMC_v1_0_6_AdminPageFramework_FieldType_export extends TMC_v1_0_6_AdminPageFramework_FieldType_submit {
