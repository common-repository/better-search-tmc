...
class TMC_v1_0_6_AdminPageFramework_FieldType_import extends TMC_v1_0_6_AdminPageFramework_FieldType_submit {
    ...
    protected function getStyles() {
        return ".tmcapf-field-import input {margin-right: 0.5em;}.tmcapf-field-import label,.form-table td fieldset.tmcapf-fieldset .tmcapf-field-import label { display: inline; }";
    }
