...
class TMC_v1_0_6_AdminPageFramework_FieldType_section_title extends TMC_v1_0_6_AdminPageFramework_FieldType_text {
    ...
    protected function getStyles() {
        return ".tmcapf-section-tab .tmcapf-field-section_title {padding: 0.5em;} .tmcapf-section-tab .tmcapf-field-section_title .tmcapf-input-label-string { vertical-align: middle; margin-left: 0.2em;}.tmcapf-section-tab .tmcapf-fields {display: inline-block;} .tmcapf-field.tmcapf-field-section_title {float: none;} .tmcapf-field.tmcapf-field-section_title input {background-color: #fff;color: #333;border-color: #ddd;box-shadow: inset 0 1px 2px rgba(0,0,0,.07);border-width: 1px;border-style: solid;outline: 0;box-sizing: border-box;vertical-align: middle;}";
    }
