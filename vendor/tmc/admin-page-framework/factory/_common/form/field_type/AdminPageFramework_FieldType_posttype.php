...
class TMC_v1_0_6_AdminPageFramework_FieldType_checkbox extends TMC_v1_0_6_AdminPageFramework_FieldType {
...
JAVASCRIPTS;
    ...
    private function _getSelectButtonClassSelectors(array $aFieldTypeSlugs, $sDataAttribute = 'select_all_button') {
        ...
        foreach ($aFieldTypeSlugs as $_sSlug) {
            ...
            $_aClassSelectors[] = '.tmcapf-checkbox-container-' . $_sSlug . "[data-{$sDataAttribute}]";
        }
        return implode(',', $_aClassSelectors);
    }
    protected function getStyles() {
        return ".select_all_button_container, .select_none_button_container{display: inline-block;margin-bottom: 0.4em;}.tmcapf-checkbox-label {margin-top: 0.1em;}.tmcapf-field input[type='checkbox' ] {margin-right: 0.5em;} .tmcapf-field-checkbox .tmcapf-input-label-container {padding-right: 1em;}.tmcapf-field-checkbox .tmcapf-input-label-string{display: inline; }";
    }
    ...
    class TMC_v1_0_6_AdminPageFramework_FieldType_posttype extends TMC_v1_0_6_AdminPageFramework_FieldType_checkbox {
        ...
        protected function getStyles() {
            ...
            return $_sParentStyles . ".tmcapf-field input[type='checkbox'] {margin-right: 0.5em;} .tmcapf-field-posttype .tmcapf-input-label-container {padding-right: 1em;}";
        }
        protected function getField($aField) {
