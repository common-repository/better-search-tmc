...
class TMC_v1_0_6_AdminPageFramework_Form_Model___SetFieldResources extends TMC_v1_0_6_AdminPageFramework_Form_Base {
    ...
    private function ___setCommon() {
        ...
        new TMC_v1_0_6_AdminPageFramework_Form_View___Script_RegisterCallback;
        $this->___setCommonFormInternalCSSRules();
    }
    private function ___setCommonFormInternalCSSRules() {
        $_aClassNames = array('TMC_v1_0_6_AdminPageFramework_Form_View___CSS_Form', 'TMC_v1_0_6_AdminPageFramework_Form_View___CSS_Field', 'TMC_v1_0_6_AdminPageFramework_Form_View___CSS_Section', 'TMC_v1_0_6_AdminPageFramework_Form_View___CSS_CollapsibleSection', 'TMC_v1_0_6_AdminPageFramework_Form_View___CSS_FieldError', 'TMC_v1_0_6_AdminPageFramework_Form_View___CSS_ToolTip',);
        foreach ($_aClassNames as $_sClassName) {
            $_oCSS = new $_sClassName;
            $this->aResources['internal_styles'][] = $_oCSS->get();
        }
        $_aClassNamesForIE = array('TMC_v1_0_6_AdminPageFramework_Form_View___CSS_CollapsibleSectionIE',);
    ...
    private function ___setFieldResourcesByFieldTypeDefinition($aFieldset, $_sFieldtype, $_aFieldTypeDefinition) {
        ...
        new TMC_v1_0_6_AdminPageFramework_Form_Model___FieldTypeRegistration($_aFieldTypeDefinition, $this->aArguments['structure_type']);
        $_oFieldTypeResources = new TMC_v1_0_6_AdminPageFramework_Form_Model___FieldTypeResource($_aFieldTypeDefinition, $this->aResources);
