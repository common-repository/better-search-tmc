...
class TMC_v1_0_6_AdminPageFramework_FrameworkUtility extends TMC_v1_0_6_AdminPageFramework_WPUtility {
    ...
    static public function getFrameworkVersion($bTrimDevVer = false) {
        $_sVersion = TMC_v1_0_6_AdminPageFramework_Registry::getVersion();
        return $bTrimDevVer ? self::getSuffixRemoved($_sVersion, '.dev') : $_sVersion;
    }
    static public function getFrameworkName() {
        return TMC_v1_0_6_AdminPageFramework_Registry::NAME;
    }
    static public function getFrameworkNameVersion() {
        return self::getFrameworkName() . ' ' . self::getFrameworkVersion();
    }
    }
    class TMC_v1_0_6_AdminPageFramework_ArrayHandler extends TMC_v1_0_6_AdminPageFramework_FrameworkUtility {
        public $aData = array();
