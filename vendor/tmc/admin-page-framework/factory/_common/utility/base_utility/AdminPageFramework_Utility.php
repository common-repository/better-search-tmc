...
abstract class TMC_v1_0_6_AdminPageFramework_Utility_Deprecated {
    static public function minifyCSS($sCSSRules) {
        TMC_v1_0_6_AdminPageFramework_Utility::showDeprecationNotice(__FUNCTION__, 'getCSSMinified()');
        return TMC_v1_0_6_AdminPageFramework_Utility_String::getCSSMinified($sCSSRules);
    }
    static public function sanitizeLength($sLength, $sUnit = 'px') {
        TMC_v1_0_6_AdminPageFramework_Utility::showDeprecationNotice(__FUNCTION__, 'getLengthSanitized()');
        return TMC_v1_0_6_AdminPageFramework_Utility_String::getLengthSanitized($sLength, $sUnit);
    }
    public static function getCorrespondingArrayValue($vSubject, $sKey, $sDefault = '', $bBlankToDefault = false) {
        TMC_v1_0_6_AdminPageFramework_Utility::showDeprecationNotice(__FUNCTION__, 'getElement()');
        if (!isset($vSubject)) {
            return $sDefault;
        }
    ...
    static public function isAssociativeArray(array $aArray) {
        TMC_v1_0_6_AdminPageFramework_Utility::showDeprecationNotice(__FUNCTION__);
    ...
    static public function getAttributes(array $aAttributes) {
        TMC_v1_0_6_AdminPageFramework_Utility::showDeprecationNotice(__METHOD__, 'TMC_v1_0_6_AdminPageFramework_WPUtility::getAttributes()');
        $_sQuoteCharactor = "'";
        $_aOutput = array();
    ...
    abstract class TMC_v1_0_6_AdminPageFramework_Utility_VariableType extends TMC_v1_0_6_AdminPageFramework_Utility_Deprecated {
    ...
    abstract class TMC_v1_0_6_AdminPageFramework_Utility_String extends TMC_v1_0_6_AdminPageFramework_Utility_VariableType {
    ...
    abstract class TMC_v1_0_6_AdminPageFramework_Utility_Array extends TMC_v1_0_6_AdminPageFramework_Utility_String {
    ...
    abstract class TMC_v1_0_6_AdminPageFramework_Utility_ArrayGetter extends TMC_v1_0_6_AdminPageFramework_Utility_Array {
    ...
    abstract class TMC_v1_0_6_AdminPageFramework_Utility_ArraySetter extends TMC_v1_0_6_AdminPageFramework_Utility_ArrayGetter {
    ...
    abstract class TMC_v1_0_6_AdminPageFramework_Utility_Path extends TMC_v1_0_6_AdminPageFramework_Utility_ArraySetter {
    ...
    abstract class TMC_v1_0_6_AdminPageFramework_Utility_URL extends TMC_v1_0_6_AdminPageFramework_Utility_Path {
    ...
    abstract class TMC_v1_0_6_AdminPageFramework_Utility_File extends TMC_v1_0_6_AdminPageFramework_Utility_URL {
    ...
    abstract class TMC_v1_0_6_AdminPageFramework_Utility_SystemInformation extends TMC_v1_0_6_AdminPageFramework_Utility_File {
    ...
    abstract class TMC_v1_0_6_AdminPageFramework_Utility_HTMLAttribute extends TMC_v1_0_6_AdminPageFramework_Utility_SystemInformation {
    ...
    class TMC_v1_0_6_AdminPageFramework_Utility extends TMC_v1_0_6_AdminPageFramework_Utility_HTMLAttribute {
