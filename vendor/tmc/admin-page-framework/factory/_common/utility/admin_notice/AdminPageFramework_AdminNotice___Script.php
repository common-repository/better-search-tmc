...
class TMC_v1_0_6_AdminPageFramework_AdminNotice___Script extends TMC_v1_0_6_AdminPageFramework_Factory___Script_Base {
...
( function( $ ) {
    jQuery( document ).ready( function() {         
        ...
        var _oAdminNotices = jQuery( '.tmcapf-settings-notice-message' );
        if ( _oAdminNotices.length ) {
            ...
            var _oContainer     = jQuery( _oAdminNotices )
                ...
                .wrap( "<div class='tmcapf-admin-notice-animation-container'></div>" );
