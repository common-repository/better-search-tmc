...
class TMC_v1_0_6_AdminPageFramework_AdminNotice extends TMC_v1_0_6_AdminPageFramework_FrameworkUtility {
    ...
    public function __construct($sNotice, array $aAttributes = array('class' => 'error'), array $aCallbacks = array()) {
        ...
        $this->aAttributes['class'] = $this->getClassAttribute($this->aAttributes['class'], 'tmcapf-settings-notice-message', 'tmcapf-settings-notice-container', 'notice', 'is-dismissible');
        $this->aCallbacks = $aCallbacks + $this->aCallbacks;
        new TMC_v1_0_6_AdminPageFramework_AdminNotice___Script;
        if (!$sNotice) {
            return;
        }
