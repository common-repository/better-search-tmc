...
class TMC_v1_0_6_AdminPageFramework_Debug_Base extends TMC_v1_0_6_AdminPageFramework_FrameworkUtility {
    ...
    class TMC_v1_0_6_AdminPageFramework_Debug_Log extends TMC_v1_0_6_AdminPageFramework_Debug_Base {
    ...
    class TMC_v1_0_6_AdminPageFramework_Debug extends TMC_v1_0_6_AdminPageFramework_Debug_Log {
        ...
        static public function dumpArray($asArray, $sFilePath = null) {
            self::showDeprecationNotice('TMC_v1_0_6_AdminPageFramework_Debug::' . __FUNCTION__, 'TMC_v1_0_6_AdminPageFramework_Debug::dump()');
            TMC_v1_0_6_AdminPageFramework_Debug::dump($asArray, $sFilePath);
        }
        static public function getArray($asArray, $sFilePath = null, $bEscape = true) {
            self::showDeprecationNotice('TMC_v1_0_6_AdminPageFramework_Debug::' . __FUNCTION__, 'TMC_v1_0_6_AdminPageFramework_Debug::get()');
            return TMC_v1_0_6_AdminPageFramework_Debug::get($asArray, $sFilePath, $bEscape);
        }
        static public function logArray($asArray, $sFilePath = null) {
            self::showDeprecationNotice('TMC_v1_0_6_AdminPageFramework_Debug::' . __FUNCTION__, 'TMC_v1_0_6_AdminPageFramework_Debug::log()');
            TMC_v1_0_6_AdminPageFramework_Debug::log($asArray, $sFilePath);
        }
        static public function getAsString($mValue) {
            self::showDeprecationNotice('TMC_v1_0_6_AdminPageFramework_Debug::' . __FUNCTION__);
