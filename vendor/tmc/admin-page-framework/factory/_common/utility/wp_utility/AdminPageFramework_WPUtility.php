...
class TMC_v1_0_6_AdminPageFramework_WPUtility_URL extends TMC_v1_0_6_AdminPageFramework_Utility {
    ...
    static public function getQueryAdminURL($aAddingQueries = array(), $aRemovingQueryKeys = array(), $sSubjectURL = '') {
        $_sAdminURL = is_network_admin() ? network_admin_url(TMC_v1_0_6_AdminPageFramework_WPUtility_Page::getPageNow()) : admin_url(TMC_v1_0_6_AdminPageFramework_WPUtility_Page::getPageNow());
    ...
    static public function getSRCFromPath($sFilePath) {
        ...
        $_sRelativePath = TMC_v1_0_6_AdminPageFramework_Utility::getRelativePath(ABSPATH, $sFilePath);
    ...
    class TMC_v1_0_6_AdminPageFramework_WPUtility_HTML extends TMC_v1_0_6_AdminPageFramework_WPUtility_URL {
    ...
    class TMC_v1_0_6_AdminPageFramework_WPUtility_Page extends TMC_v1_0_6_AdminPageFramework_WPUtility_HTML {
    ...
    class TMC_v1_0_6_AdminPageFramework_WPUtility_Hook extends TMC_v1_0_6_AdminPageFramework_WPUtility_Page {
    ...
    class TMC_v1_0_6_AdminPageFramework_WPUtility_File extends TMC_v1_0_6_AdminPageFramework_WPUtility_Hook {
    ...
    class TMC_v1_0_6_AdminPageFramework_WPUtility_Option extends TMC_v1_0_6_AdminPageFramework_WPUtility_File {
    ...
    class TMC_v1_0_6_AdminPageFramework_WPUtility_Meta extends TMC_v1_0_6_AdminPageFramework_WPUtility_Option {
    ...
    class TMC_v1_0_6_AdminPageFramework_WPUtility_SiteInformation extends TMC_v1_0_6_AdminPageFramework_WPUtility_Meta {
    ...
    class TMC_v1_0_6_AdminPageFramework_WPUtility_SystemInformation extends TMC_v1_0_6_AdminPageFramework_WPUtility_SiteInformation {
    ...
    class TMC_v1_0_6_AdminPageFramework_WPUtility extends TMC_v1_0_6_AdminPageFramework_WPUtility_SystemInformation {
