...
abstract class TMC_v1_0_6_AdminPageFramework_Widget_Router extends TMC_v1_0_6_AdminPageFramework_Factory {
    ...
    abstract class TMC_v1_0_6_AdminPageFramework_Widget_Model extends TMC_v1_0_6_AdminPageFramework_Widget_Router {
        ...
        public function _replyToRegisterWidget() {
            ...
            $GLOBALS['wp_widget_factory']->widgets[$this->oProp->sClassName] = new TMC_v1_0_6_AdminPageFramework_Widget_Factory($this, $this->oProp->sWidgetTitle, $this->oUtil->getAsArray($this->oProp->aWidgetArguments));
            $this->oProp->oWidget = $GLOBALS['wp_widget_factory']->widgets[$this->oProp->sClassName];
        }
    }
    abstract class TMC_v1_0_6_AdminPageFramework_Widget_View extends TMC_v1_0_6_AdminPageFramework_Widget_Model {
    ...
    abstract class TMC_v1_0_6_AdminPageFramework_Widget_Controller extends TMC_v1_0_6_AdminPageFramework_Widget_View {
    ...
    abstract class TMC_v1_0_6_AdminPageFramework_Widget extends TMC_v1_0_6_AdminPageFramework_Widget_Controller {
        protected $_sStructureType = 'widget';
        public function __construct() {
            $_sThisClassName = get_class($this);
            $_bAssumedAsWPWidget = 0 === func_num_args();
            $_aDefaults = array('', array(), 'edit_theme_options', 'tmcapf');
