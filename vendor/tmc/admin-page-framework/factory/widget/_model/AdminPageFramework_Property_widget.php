...
class TMC_v1_0_6_AdminPageFramework_Property_widget extends TMC_v1_0_6_AdminPageFramework_Property_Base {
    ...
    public function __construct($oCaller, $sCallerPath, $sClassName, $sCapability = 'manage_options', $sTextDomain = 'tmcapf', $sStructureType) {
