...
class TMC_v1_0_6_AdminPageFramework_Form_widget extends TMC_v1_0_6_AdminPageFramework_Form {
    public $sStructureType = 'widget';
    public function construct() {
        $this->_addDefaultResources();
    }
    private function _addDefaultResources() {
        $_oCSS = new TMC_v1_0_6_AdminPageFramework_Form_View___CSS_widget;
