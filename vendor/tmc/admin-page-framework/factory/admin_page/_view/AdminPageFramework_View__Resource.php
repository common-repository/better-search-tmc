...
class TMC_v1_0_6_AdminPageFramework_View__Resource extends TMC_v1_0_6_AdminPageFramework_FrameworkUtility {
    public $oFactory;
    ...
    private function _enqueueAsset_style($asPageStyle) {
        $_oFormatter = new TMC_v1_0_6_AdminPageFramework_Format_PageResource_Style($asPageStyle);
    ...
    private function _enqueueAsset_script($asPageScript) {
        $_oFormatter = new TMC_v1_0_6_AdminPageFramework_Format_PageResource_Script($asPageScript);
