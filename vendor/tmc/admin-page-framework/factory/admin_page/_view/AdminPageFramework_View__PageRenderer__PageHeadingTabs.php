...
class TMC_v1_0_6_AdminPageFramework_View__PageRenderer__PageHeadingTabs extends TMC_v1_0_6_AdminPageFramework_FrameworkUtility {
    public $oFactory;
    public $sPageSlug;
    public $sTag = 'h2';
    ...
    private function _getPageHeadingtabNavigationBar(array $aPages, $sTag, $sCurrentPageSlug) {
        $_oTabBar = new TMC_v1_0_6_AdminPageFramework_TabNavigationBar($aPages, $sCurrentPageSlug, $sTag, array(), array('format' => array($this, '_replyToFormatNavigationTabItem_PageHeadingTab'),));
        $_sTabBar = $_oTabBar->get();
        return $_sTabBar ? "<div class='tmcapf-page-heading-tab'>" . $_sTabBar . "</div>" : '';
    }
