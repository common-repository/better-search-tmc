...
class TMC_v1_0_6_AdminPageFramework_Format_InPageTabs extends TMC_v1_0_6_AdminPageFramework_Format_Base {
    ...
    public function get() {
        ...
        foreach (( array )$_aInPageTabs as $_sTabSlug => $_aInPageTab) {
            ...
            $_oFormatter = new TMC_v1_0_6_AdminPageFramework_Format_InPageTab($_aInPageTab, $this->sPageSlug, $this->oFactory);
