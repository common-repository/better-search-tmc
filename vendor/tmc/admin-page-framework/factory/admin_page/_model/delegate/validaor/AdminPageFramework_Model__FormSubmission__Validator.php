...
class TMC_v1_0_6_AdminPageFramework_Model__FormSubmission__Validator_Base extends TMC_v1_0_6_AdminPageFramework_Model__FormSubmission_Base {
    public $oFactory;
    ...
    class TMC_v1_0_6_AdminPageFramework_Model__FormSubmission__Validator extends TMC_v1_0_6_AdminPageFramework_Model__FormSubmission__Validator_Base {
        public $oFactory;
        ...
        public function _replyToValidateUserFormInputs($aInputs, $aRawInputs, $aOptions, $oFactory) {
            ...
            $_aClassNames = array('TMC_v1_0_6_AdminPageFramework_Model__FormSubmission__Validator__Link', 'TMC_v1_0_6_AdminPageFramework_Model__FormSubmission__Validator__Redirect', 'TMC_v1_0_6_AdminPageFramework_Model__FormSubmission__Validator__Import', 'TMC_v1_0_6_AdminPageFramework_Model__FormSubmission__Validator__Export', 'TMC_v1_0_6_AdminPageFramework_Model__FormSubmission__Validator__Reset', 'TMC_v1_0_6_AdminPageFramework_Model__FormSubmission__Validator__ResetConfirm', 'TMC_v1_0_6_AdminPageFramework_Model__FormSubmission__Validator__ContactForm', 'TMC_v1_0_6_AdminPageFramework_Model__FormSubmission__Validator__ContactFormConfirm',);
            ...
            try {
                ...
                $_oFormSubmissionFilter = new TMC_v1_0_6_AdminPageFramework_Model__FormSubmission__Validator__Filter($this->oFactory, $aInputs, $aRawInputs, $aOptions, $_aSubmitsInformation);
