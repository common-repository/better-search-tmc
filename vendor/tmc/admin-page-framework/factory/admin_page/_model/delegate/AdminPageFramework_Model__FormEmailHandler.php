...
class TMC_v1_0_6_AdminPageFramework_Model__FormEmailHandler extends TMC_v1_0_6_AdminPageFramework_FrameworkUtility {
    public $oFactory;
    ...
    public function _replyToSendFormEmail() {
        ...
        $_oEmail = new TMC_v1_0_6_AdminPageFramework_FormEmail($_aFormEmail['email_options'], $_aFormEmail['input'], $_aFormEmail['section_id']);
        $_bSent = $_oEmail->send();
        exit;
    }
    }
