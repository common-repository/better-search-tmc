...
abstract class TMC_v1_0_6_AdminPageFramework_Model__FormSubmission_Base extends TMC_v1_0_6_AdminPageFramework_Form_Utility {
    ...
    class TMC_v1_0_6_AdminPageFramework_Model__FormSubmission extends TMC_v1_0_6_AdminPageFramework_Model__FormSubmission_Base {
        public $oFactory;
        public function __construct($oFactory, $aSavedData, $aArguments, $aSectionsets, $aFieldsets) {
            $this->oFactory = $oFactory;
            $this->_handleFormData();
            new TMC_v1_0_6_AdminPageFramework_Model__FormRedirectHandler($oFactory);
        }
        public function _handleFormData() {
            ...
            new TMC_v1_0_6_AdminPageFramework_Model__FormSubmission__Validator($this->oFactory);
