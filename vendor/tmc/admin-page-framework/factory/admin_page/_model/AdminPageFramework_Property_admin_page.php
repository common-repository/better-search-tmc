...
class TMC_v1_0_6_AdminPageFramework_Property_admin_page extends TMC_v1_0_6_AdminPageFramework_Property_Base {
    ...
    public function __construct($oCaller, $sCallerPath, $sClassName, $aisOptionKey, $sCapability = 'manage_options', $sTextDomain = 'tmcapf') {
        ...
        $GLOBALS['aTMC_v1_0_6_AdminPageFramework']['aPageClasses'] = $this->getElementAsArray($GLOBALS, array('aTMC_v1_0_6_AdminPageFramework', 'aPageClasses'));
        $GLOBALS['aTMC_v1_0_6_AdminPageFramework']['aPageClasses'][$sClassName] = $oCaller;
