...
abstract class TMC_v1_0_6_AdminPageFramework_CustomSubmitFields extends TMC_v1_0_6_AdminPageFramework_FrameworkUtility {
    public $aPost = array();
    public $sInputID;
    ...
    class TMC_v1_0_6_AdminPageFramework_ExportOptions extends TMC_v1_0_6_AdminPageFramework_CustomSubmitFields {
        public $sClassName;
        public $sFileName;
        public $sFormatType;
        public $bIsDataSet;
            ...
            switch (strtolower($sFormatType)) {
                case 'text':
                    if (in_array(gettype($vData), array('array', 'object'))) {
                        echo TMC_v1_0_6_AdminPageFramework_Debug::get($vData, null, false);
                    }
                    echo $vData;
                    return;
                case 'json':
