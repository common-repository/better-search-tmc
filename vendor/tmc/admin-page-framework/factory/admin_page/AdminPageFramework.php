...
abstract class TMC_v1_0_6_AdminPageFramework_Router extends TMC_v1_0_6_AdminPageFramework_Factory {
    public function __construct($sOptionKey = null, $sCallerPath = null, $sCapability = 'manage_options', $sTextDomain = 'tmcapf') {
        $_sPropertyClassName = isset($this->aSubClassNames['oProp']) ? $this->aSubClassNames['oProp'] : 'TMC_v1_0_6_AdminPageFramework_Property_' . $this->_sStructureType;
    ...
    public function _replyToLoadComponentsForAjax() {
        ...
        new TMC_v1_0_6_AdminPageFramework_Model_Menu__RegisterMenu($this, 'pseudo_admin_menu');
    ...
    abstract class TMC_v1_0_6_AdminPageFramework_Model_Form extends TMC_v1_0_6_AdminPageFramework_Router {
        public $aFieldErrors;
        ...
        public function __construct($sOptionKey = null, $sCallerPath = null, $sCapability = 'manage_options', $sTextDomain = 'tmcapf') {
            ...
            new TMC_v1_0_6_AdminPageFramework_Model__FormEmailHandler($this);
        ...
        public function _replyToHandleSubmittedFormData($aSavedData, $aArguments, $aSectionsets, $aFieldsets) {
            new TMC_v1_0_6_AdminPageFramework_Model__FormSubmission($this, $aSavedData, $aArguments, $aSectionsets, $aFieldsets);
        }
    ...
    abstract class TMC_v1_0_6_AdminPageFramework_View_Form extends TMC_v1_0_6_AdminPageFramework_Model_Form {
    ...
    abstract class TMC_v1_0_6_AdminPageFramework_Controller_Form extends TMC_v1_0_6_AdminPageFramework_View_Form {
        ...
        public function getValue() {
            ...
            return TMC_v1_0_6_AdminPageFramework_WPUtility::getOption($this->oProp->sOptionKey, empty($_aParams) ? null : $_aDimensionalKeys, $_mDefault, $this->getSavedOptions() + $this->oForm->getDefaultFormValues());
        }
    ...
    abstract class TMC_v1_0_6_AdminPageFramework_Model_Page extends TMC_v1_0_6_AdminPageFramework_Controller_Form {
        public function _replyToFinalizeInPageTabs() {
            ...
            foreach ($this->oProp->aPages as $_sPageSlug => $_aPage) {
                ...
                $_oFormatter = new TMC_v1_0_6_AdminPageFramework_Format_InPageTabs($this->oProp->aInPageTabs[$_sPageSlug], $_sPageSlug, $this);
    ...
    abstract class TMC_v1_0_6_AdminPageFramework_View_Page extends TMC_v1_0_6_AdminPageFramework_Model_Page {
        public function _replyToEnablePageMetaBoxes() {
            new TMC_v1_0_6_AdminPageFramework_View__PageMetaboxEnabler($this);
        }
        public function _replyToEnqueuePageAssets() {
            new TMC_v1_0_6_AdminPageFramework_View__Resource($this);
        }
        ...
        protected function _renderPage($sPageSlug, $sTabSlug = null) {
            $_oPageRenderer = new TMC_v1_0_6_AdminPageFramework_View__PageRenderer($this, $sPageSlug, $sTabSlug);
            $_oPageRenderer->render();
        }
    }
    abstract class TMC_v1_0_6_AdminPageFramework_Controller_Page extends TMC_v1_0_6_AdminPageFramework_View_Page {
    ...
    abstract class TMC_v1_0_6_AdminPageFramework_Model_Menu extends TMC_v1_0_6_AdminPageFramework_Controller_Page {
        public function __construct($sOptionKey = null, $sCallerPath = null, $sCapability = 'manage_options', $sTextDomain = 'tmcapf') {
            parent::__construct($sOptionKey, $sCallerPath, $sCapability, $sTextDomain);
            new TMC_v1_0_6_AdminPageFramework_Model_Menu__RegisterMenu($this);
        }
    }
    abstract class TMC_v1_0_6_AdminPageFramework_View_Menu extends TMC_v1_0_6_AdminPageFramework_Model_Menu {
    }
    abstract class TMC_v1_0_6_AdminPageFramework_Controller_Menu extends TMC_v1_0_6_AdminPageFramework_View_Menu {
        ...
        public function addSubMenuLink(array $aSubMenuLink) {
            ...
            $_oFormatter = new TMC_v1_0_6_AdminPageFramework_Format_SubMenuLink($aSubMenuLink, $this, count($this->oProp->aPages) + 1);
        ...
        public function addSubMenuPage(array $aSubMenuPage) {
            ...
            $_oFormatter = new TMC_v1_0_6_AdminPageFramework_Format_SubMenuPage($aSubMenuPage, $this, count($this->oProp->aPages) + 1);
            $_aSubMenuPage = $_oFormatter->get();
            $this->oProp->aPages[$_aSubMenuPage['page_slug']] = $_aSubMenuPage;
        }
    }
    abstract class TMC_v1_0_6_AdminPageFramework_Model extends TMC_v1_0_6_AdminPageFramework_Controller_Menu {
    }
    abstract class TMC_v1_0_6_AdminPageFramework_View extends TMC_v1_0_6_AdminPageFramework_Model {
        public function content($sContent) {
            return $sContent;
        }
    }
    abstract class TMC_v1_0_6_AdminPageFramework_Controller extends TMC_v1_0_6_AdminPageFramework_View {
        ...
        public function setAdminNotice($sMessage, $sClassSelector = 'error', $sID = '') {
            ...
            new TMC_v1_0_6_AdminPageFramework_AdminNotice($this->oProp->aAdminNotices[$sID]['sMessage'], $this->oProp->aAdminNotices[$sID]['aAttributes'], array('should_show' => array($this, 'isInThePage'),));
        }
        ...
        static public function getOption($sOptionKey, $asKey = null, $vDefault = null) {
            return TMC_v1_0_6_AdminPageFramework_WPUtility::getOption($sOptionKey, $asKey, $vDefault);
        }
    }
    abstract class TMC_v1_0_6_AdminPageFramework extends TMC_v1_0_6_AdminPageFramework_Controller {
        protected $_sStructureType = 'admin_page';
        public function __construct($isOptionKey = null, $sCallerPath = null, $sCapability = 'manage_options', $sTextDomain = 'tmcapf') {
        ...
        private function _getCallerPath($sCallerPath) {
            ...
            $_sCalllerPath = in_array($GLOBALS['pagenow'], array('plugins.php',)) || isset($_GET['page']) ? TMC_v1_0_6_AdminPageFramework_Utility::getCallerScriptPath(__FILE__) : null;
