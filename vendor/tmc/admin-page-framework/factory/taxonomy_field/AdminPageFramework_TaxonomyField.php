...
abstract class TMC_v1_0_6_AdminPageFramework_TaxonomyField_Router extends TMC_v1_0_6_AdminPageFramework_Factory {
    ...
    abstract class TMC_v1_0_6_AdminPageFramework_TaxonomyField_Model extends TMC_v1_0_6_AdminPageFramework_TaxonomyField_Router {
    ...
    abstract class TMC_v1_0_6_AdminPageFramework_TaxonomyField_View extends TMC_v1_0_6_AdminPageFramework_TaxonomyField_Model {
    ...
    abstract class TMC_v1_0_6_AdminPageFramework_TaxonomyField_Controller extends TMC_v1_0_6_AdminPageFramework_TaxonomyField_View {
        public function setUp() {
        }
    }
    abstract class TMC_v1_0_6_AdminPageFramework_TaxonomyField extends TMC_v1_0_6_AdminPageFramework_TaxonomyField_Controller {
        protected $_sStructureType = 'taxonomy_field';
        function __construct($asTaxonomySlug, $sOptionKey = '', $sCapability = 'manage_options', $sTextDomain = 'tmcapf') {
