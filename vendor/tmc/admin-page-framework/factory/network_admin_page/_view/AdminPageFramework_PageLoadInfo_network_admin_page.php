...
class TMC_v1_0_6_AdminPageFramework_PageLoadInfo_network_admin_page extends TMC_v1_0_6_AdminPageFramework_PageLoadInfo_Base {
    ...
    public static function instantiate($oProp, $oMsg) {
        ...
        self::$_oInstance = new TMC_v1_0_6_AdminPageFramework_PageLoadInfo_network_admin_page($oProp, $oMsg);
        return self::$_oInstance;
    }
