...
abstract class TMC_v1_0_6_AdminPageFramework_PluginBootstrap {
    public $sFilePath;
    public $bIsAdmin;
    public $sHookPrefix;
    ...
    protected function _registerClasses() {
        if (!class_exists('TMC_v1_0_6_AdminPageFramework_RegisterClasses', false)) {
            return;
        }
        new TMC_v1_0_6_AdminPageFramework_RegisterClasses($this->getScanningDirs(), array(), $this->getClasses());
    }
