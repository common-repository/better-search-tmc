<?php
/**
 * TMC_v1_0_6_AceCustomFieldType, for the  Admin Page Framework by Michael Uno, is written by Per Soderlind - http://soderlind.no
 */
if ( ! class_exists( 'TMC_v1_0_6_AceCustomFieldType' ) ) :
class TMC_v1_0_6_AceCustomFieldType extends TMC_v1_0_6_AdminPageFramework_FieldType {
            ...
            jQuery().registerAPFCallback( {
                ...
                */
                added_repeatable_field: function( oCopied, sFieldType, sFieldTagID, iCallType ) {
                    ...
                    oCopied.closest( '.tmcapf-field' ).nextAll().andSelf().each( function( iIndex ) {
