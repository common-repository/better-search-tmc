...
if ( ! class_exists( 'TMC_v1_0_6_ToggleCustomFieldType' ) ) :
/**
 ...
 */
class TMC_v1_0_6_ToggleCustomFieldType extends TMC_v1_0_6_AdminPageFramework_FieldType_checkbox {
        ...
        return "jQuery( document ).ready( function(){
            ...
            jQuery( '.switch_toggle_buttons' ).each( function () {
                ...
                jQuery( this ).closest( '.tmcapf-field' )
                    .children( '.tmcapf-checkbox-container-toggle' )
                    .hide();
