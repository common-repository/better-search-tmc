...
if ( ! class_exists( 'TMC_v1_0_6_Select2CustomFieldType' ) ) :
/**
 ...
 */
class TMC_v1_0_6_Select2CustomFieldType extends TMC_v1_0_6_AdminPageFramework_FieldType_select {
...
"jQuery( document ).ready( function(){
    ...
    var _initializeSelect2 = function( oNode ) {
        ...
        if ( _aOptions[ 'width' ] && 'auto' !== _aOptions[ 'width' ] ) {
            var _oFieldContainer = _oSelect2Target.closest( '.tmcapf-field-select2' );
            _oFieldContainer.css( 'width', _aOptions[ 'width' ] );
            _oFieldContainer.children( '.tmcapf-select-label' )
                .css( 'width', '100%' );
            _oFieldContainer.children( '.tmcapf-select-label' )
                .children( 'label' )
                .children( '.tmcapf-input-container' )
                .css( 'width', '100%' );
            _aOptions[ 'width' ] = '100%';
        }
        ...
        if ( _aOptions[ 'search_callback' ] ) {
             ...
             * Set inital values.
             */
            var _oInputForEncoded = _oSelect2Target.closest( '.tmcapf-field' )
            ...
            _oSelect2Target.on( 'change', function( event ){
                ...
                jQuery( this ).closest( '.tmcapf-field' )
                    .children( 'input[data-encoded]' ).first()
    ...
    protected function getStyles() {
        return "
.tmcapf-field-select2 .select2-container {     
    min-width: 200px;
    width: auto;
}

.tmcapf-field-select2 {
    max-width: 96%;
}

/* Make a room for repeatable buttons */
.repeatable .tmcapf-field-select2 > .tmcapf-select-label > label > .tmcapf-input-container {
    max-width: 84%;
}
