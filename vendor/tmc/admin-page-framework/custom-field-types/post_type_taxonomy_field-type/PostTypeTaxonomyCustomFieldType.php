 ...
 * @package     TMC_v1_0_6_AdminPageFramework
 */

if ( ! class_exists( 'TMC_v1_0_6_PostTypeTaxonomyCustomFieldType' ) ) :
/**
 ...
 */
class TMC_v1_0_6_PostTypeTaxonomyCustomFieldType extends TMC_v1_0_6_AdminPageFramework_FieldType_taxonomy {
...
jQuery( document ).ready( function(){
    ...
    jQuery( '.tmcapf-checkbox-container-posttype[data-select_all_button]' ).each( function( iIndex ){
        jQuery( this ).before( '<div class=\"select_all_button_container\" onclick=\"jQuery( this ).selectAllTMC_v1_0_6_AdminPageFrameworkCheckboxes(); return false;\"><a class=\"select_all_button button button-small\">' + jQuery( this ).data( 'select_all_button' ) + '</a></div>' );
    });            
    jQuery( '.tmcapf-checkbox-container-posttype[data-select_none_button]' ).each( function( iIndex ){
        jQuery( this ).before( '<div class=\"select_none_button_container\" onclick=\"jQuery( this ).deselectAllTMC_v1_0_6_AdminPageFrameworkCheckboxes(); return false;\"><a class=\"select_all_button button button-small\">' + jQuery( this ).data( 'select_none_button' ) + '</a></div>' );
    });
    
    // When the post type check-boxes are clicked, show/hide the corresponding taxonomy elements.
    jQuery( document ).on( 'change', '.tmcapf-field-post_type_taxonomy .tmcapf-field-posttype input[type="checkbox"]', function() {
        ...
        var _oField              = jQuery( this ).closest( '.tmcapf-field-post_type_taxonomy' );
    ...
    jQuery( '.tmcapf-field-post_type_taxonomy .tmcapf-field-posttype input[type="checkbox"]:not(:checked)' ).each( function(){
        jQuery( this ).trigger( 'change' );
    } );
    

    jQuery().registerTMC_v1_0_6_AdminPageFrameworkCallbacks( {
        /**
        ...
        repeated_field: function( oCloned, aModel ) {
            ...
            oCloned.find( '.tmcapf-field-posttype input[type="checkbox"]' )
                .prop( 'checked', false )
                .trigger( 'change' );         
...
.tmcapf-field-post_type_taxonomy .select_all_button_container, 
.tmcapf-field-post_type_taxonomy .select_none_button_container
{
...
.tmcapf-field-post_type_taxonomy .select-taxonomy-terms-checkbox-container {
            ...
            return "<div class='select-taxonomy-terms-checkbox-container'>"
                    . "<label class='select-taxonomy-terms'>"
                        ...
                        . "<input " . $this->getAttributes( $_aCheckboxAttributes ) . " />"
                            . __( 'Select taxonomy terms.', 'tmcapf-loader' )
                    . "</label>"
                . "</div>";
