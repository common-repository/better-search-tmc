<?php
if ( ! class_exists( 'TMC_v1_0_6_GitHubCustomFieldType' ) ) :
/**
 * @version     1.0.1
 */
class TMC_v1_0_6_GitHubCustomFieldType extends TMC_v1_0_6_AdminPageFramework_FieldType {
    ...
    protected function getField( $aField ) { 
        ...
        return 
            $aField['before_label']
            . "<div class='tmcapf-input-label-container'>"        
                . $aField['before_input']
                . ( $aField['label'] && ! $aField['repeatable']
                    ? "<span class='tmcapf-input-label-string' style='min-width:" . $this->getLengthSanitized( $aField['label_min_width'] ) . ";'>" . $aField['label'] . "</span>"
                    : "" 
                )
        ...
        private function _getButtonLabelByType( $sButtonType, $sUserName, $sValue ) {
            ...
            switch( $sButtonType ) {
                case 'follow': 
                    return sprintf( __( 'Follow @%1$s', 'tmcapf' ), $sUserName );
                case 'watch':
                    return __( 'Watch', 'tmcapf' );
                case 'star':
                    return __( 'Star', 'tmcapf' );
                case 'fork':
                    return __( 'Fork', 'tmcapf' );
                case 'issue':
                    return __( 'Issue', 'tmcapf' );
                default:
                    return '';
            }                 
